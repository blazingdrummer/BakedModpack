...
- Added Warped Echoes to default Item Blacklist.
	- If updating from an earlier version, add DelayedDamage to your blacklist config.

`1.6.3`

- Recompiled for DLC2.
- Updated default Item Blacklist
	- Antler Shield
	- Chance Doll
	- Prayer Beads
	- Sale Star
...
- Updated default Vengeance Blacklist
	- Antler Shield
	- Noxious Thorn
