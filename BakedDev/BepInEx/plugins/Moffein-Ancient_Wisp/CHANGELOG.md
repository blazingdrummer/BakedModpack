...
- Fixed deathsounds not playing online.
- Spawned minions now inherit Ghost/HealthDecay like vanilla enemies.
...
- Fixed for DLC2.
	...
	*Special thanks to Viliger for figuring out why the lightning vfx was broken!*

- Added DLC2 elite displays.

- Added to:
	- Reformed Altar
	- Helminth Hatchery
	
	*You will need to update your config to get them to spawn on these stages.*
